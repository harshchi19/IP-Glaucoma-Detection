...
st.title("AI-Powered Glaucoma Detection using Resnet18")
st.header("Early Detection of Glaucoma from Retina Images")
st.write("""
This application uses a deep learning model to analyze retina images and detect signs of glaucoma. Upload a fundus image, 
and the system will predict whether glaucoma is present or not. Early diagnosis is crucial for managing and treating glaucoma, 
and this tool provides a quick, AI-based assessment.
""")
