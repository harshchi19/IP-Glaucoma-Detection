...
def show_img_with_heatmap(img_path, heatmap, alpha=0.5):
...
def glaucoma_detection_app():
    ...
    with st.sidebar:
        choose = option_menu("Content", ["Glaucoma", "Glaucoma Statistics", "Glaucoma Analysis Tool"],
                             ...
                             menu_icon="app-indicator", default_index=0, key="sidebar_menu_harsh",
                             styles={
    ...
    # Remaining UI logic based on menu choice follows here
    # Place the rest of your UI code here, handling each option separately
